...
def main(input_csv, output_csv, prompt_path, llm_model_path):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='RAG 对话摘要提取与清洗')
    parser.add_argument('--input', required=True, help='输入 CSV 文件')
    parser.add_argument('--output', required=True, help='输出 CSV 文件')
    parser.add_argument('--prompt', required=True, help='Prompt 模板文件')
